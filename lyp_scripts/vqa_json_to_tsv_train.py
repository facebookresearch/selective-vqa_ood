...
def main(
    ...
    print(f"Converting {questions_path} to {output_path}")
    ...
    with open(output_path, "w", newline="") as tsvfile:
        ...
        for question, annotation in tqdm(zip(questions, annotations)):
            ...
            image_name = f"COCO_train2014_{str(image_id).zfill(12)}.jpg"
            ...
            if format == "train":
                ans_and_scores = get_score_from_answers_train(all_answers)
                for ans, ans_str in ans_and_scores:
                    ...
                    line = [
                        ...
                        question["image_id"],
                        encode_question(question["question"]),
                        ans_str,
                        "",  # objects
                        img_data,
                    ]
                ...
                ans_str = get_score_from_answers_val(all_answers)
                line = [
                    question["question_id"],
                    question["image_id"],
                    encode_question(question["question"]),
...
if __name__ == "__main__":
    ...
    parser.add_argument("--format", default="train", choices=["train", "val"])
