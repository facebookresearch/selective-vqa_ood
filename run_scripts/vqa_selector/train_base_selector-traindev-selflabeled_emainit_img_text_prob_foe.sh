...
data=${data_dir}/traindev-selflabeled.tsv,${data_dir}/imdb_val2014-predval.tsv

ans2label_file=../../datasets/vqa2/trainval_ans2label.pkl
finetune_from_model=./vqa_checkpoints/base_no_obj_trainonly/12_0.04_5e-5_480/checkpoint_best.pt
