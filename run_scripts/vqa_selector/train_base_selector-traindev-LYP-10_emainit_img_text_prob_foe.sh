...
# data=${data_dir}/trainval-10-subsets/,${data_dir}/imdb_val2014-predval.imgpaths.tsv
data=../../../ofa/ofa-data/vqa_data/trainval-10-subsets/conf-labeled.valformat.shuf.tsv,${data_dir}/imdb_val2014-predval.tsv
...
name=base_selector-traindev-selflabeled_feats-img-text-prob-first_output_emb
