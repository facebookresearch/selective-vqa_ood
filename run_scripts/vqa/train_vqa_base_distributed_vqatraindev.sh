...
data=${data_dir}/vqa_train_and_val-val.trainformat.shuf.tsv,${data_dir}/imdb_val2014-predvals.tsv
...
restore_file=../../checkpoints/checkpoints/ofa_base.pt
selected_cols=0,5,2,3,4

name=base_no_obj_trainval
