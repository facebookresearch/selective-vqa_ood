...
def load_ema_from_checkpoint(fpath):
    ...
    with PathManager.open(fpath, 'rb') as f:
        ...
        model_params = new_state["extra_state"]["ema_fp32_params"] if "ema_fp32_params" in new_state["extra_state"] else new_state["extra_state"]["ema"]
